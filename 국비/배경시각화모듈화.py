...
def visualize_seoul_stores(geojson_file, csv_file, store_locations):
    # GeoJSON 파일 불러오기
    ...
    # 행정동 주소를 기준으로 데이터 병합
    merged_data = geo_data.merge(csv_data, left_on='adm_nm', right_on='행정동')
...
csv_file = '내가씀.csv'
store_locations = {
    '담꾹 길음점': (37.6066, 127.02152),
    'NBM 신정역점': (37.52497, 126.85483)
}

visualize_seoul_stores(geojson_file, csv_file, store_locations)